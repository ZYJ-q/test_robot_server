...
// use super::actions;
// use super::{AlarmUnit, enums::VenueApi};

// #[warn(dead_code)]
// async fn test() -> String {
//     let alarm_unit: AlarmUnit =
//         serde_json::from_str(&fs::read_to_string("./configs/test_receive.json").unwrap()).unwrap();
//     let mut venues: HashMap<String, VenueApi> = HashMap::new();
//     venues.insert(String::from("BinanceFutures"), VenueApi::BinanceFuturesApi);
//     return actions::get_real_time(alarm_unit, venues).await;
// }

// #[warn(dead_code)]
// pub async fn test_real_time() {
//     test().await;
// }
...
// #[warn(dead_code)]
// async fn test_http() -> std::io::Result<()> {
...
//             .service(web::resource("/signIn").route(web::post().to(index_manual)))
//     })
//     .bind(("127.0.0.1", 8080))?
//     .run()
//     .await
